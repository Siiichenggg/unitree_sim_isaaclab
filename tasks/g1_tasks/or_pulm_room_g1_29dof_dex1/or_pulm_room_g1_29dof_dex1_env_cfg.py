...
"""G1 Dex1 environment using the pulmonary operating-room USD as the default scene."""
...
from tasks.common_scene.base_scene_or_rooms import PulmOperatingRoomSceneCfg


@configclass
class ORPulmRoomSceneCfg(PulmOperatingRoomSceneCfg):
    """Pulmonary OR scene with a mobile G1 placed on the open floor area."""

    robot: ArticulationCfg = G1RobotPresets.g1_29dof_dex1_wholebody(
        init_pos=(2.1, -1.2, 1.0),
...
@configclass
class ORPulmRoomG129DEX1EnvCfg(ManagerBasedRLEnvCfg):
    """Manager-based mobile G1 Dex1 environment in the pulmonary operating room."""

    scene: ORPulmRoomSceneCfg = ORPulmRoomSceneCfg(num_envs=1, env_spacing=2.5, replicate_physics=True)
